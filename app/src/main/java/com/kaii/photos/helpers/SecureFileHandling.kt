...
fun File.secureDecryptCacheFile(context: Context) = File(context.appSecureThumbnailCacheDir, "${nameWithoutExtension}-decrypt.${extension}")
fun File.secureDecryptVideoFile(context: Context) = File(context.appSecureVideoCacheDir, name)
